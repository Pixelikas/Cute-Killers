...
for (var i = 0; i < array_length_1d(options); i++){
            ...
            if mouse_check_button_pressed(mb_left) {
                if i == 0 {
                    ...
                    if music == false {
                        ...
                        audio_play_sound(menu_snd, 0, true);
                    }
                } else if i == 1 {
    ...
    if i == 0 {
        draw_sprite(checkbox_spr, 0, x + space + text_music_width, y - checkbox_height/2);
    }
}

if hover != true {
    draw_sprite(sprite_menu_index, 0, x + 16, y + mpos * space);
}

if music == true {
   draw_sprite(tick_spr, 0, x + space + text_music_width, y - checkbox_height/2);
}
